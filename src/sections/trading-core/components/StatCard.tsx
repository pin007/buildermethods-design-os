...
const iconColors: Record<ChangeType, string> = {
  ...
  neutral: 'text-zinc-300 dark:text-zinc-600',
...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">
        {label}
      </p>
      ...
      {isClickable && (
        <div className="absolute right-4 top-1/2 -translate-y-1/2 opacity-0 transition-opacity group-hover:opacity-100">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-zinc-300 dark:text-zinc-600">
