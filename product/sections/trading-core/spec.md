...
- **Source badge:** the generating source — strategy name (e.g., "Golden Cross") for strategy signals or "Market Analyst" for AI Research
...
This chip MUST be used consistently across recommendation lists, the approval card's AI Recommendation section, and any dashboard recommendation surfaces, so every AI-originated action can be traced back to its source, confidence, and reasoning.
